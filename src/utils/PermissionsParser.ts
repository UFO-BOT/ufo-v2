import {BitFieldResolvable, PermissionResolvable} from "discord.js";
import Language from "@/types/Language";

export default class PermissionsParser {
    public static parse(perms: PermissionResolvable, lang: Language): Array<string> {
        let permsArray = perms as Array<string>;
        return permsArray.map(perm => this.perms[lang][perm]);
    }

    private static perms: Record<Language, Record<string, string>> = {
        ru: {
